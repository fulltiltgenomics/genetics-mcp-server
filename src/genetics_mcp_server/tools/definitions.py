...
CODE_EXECUTION_TOOL_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "DOWNLOAD LINKS automatically: name them in your "
            ...
            "DELIVERY LIMITS: an artifact over 512 KB is delivered nowhere — not shown, not "
            "offered, not readable — and at most 4 images and 4 other files are delivered per "
            "run, in name order. A heatmap with hundreds of rows at 130 dpi is over the cap: "
            "keep figures to 100 dpi and a few thousand pixels a side, and write one combined "
            "table rather than many. The result lists anything not delivered under "
            "artifacts_not_delivered with the reason; never describe a plot that was not "
            "shown or name a file the user was not offered.\n\n"
